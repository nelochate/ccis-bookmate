        ...
        <v-col cols="12" md="6" class="pa-8 d-flex justify-center align-center">
          <v-card class="pa-6 text-center elevation-0 rounded-x0" max-width="600" color="transparent">
            ...
            <p class="text-body-1 text-medium-emphasis">
              Easily book and manage facilities within the CCIS building — your centralized platform
              for hassle-free scheduling and access.
            </p>
          </v-card>
        </v-col>
          ...
          <v-card class="mx-auto" width="400" elevation="15">
            ...
            <v-card-text class="bg-surface-light pt-4">
              ...
              <h4 class="text-center">
                Already have an account?<RouterLink to="/" class="text-primary"> Login</RouterLink>
              </h4>
            </v-card-text>
          </v-card>
        </v-col>
